...
Run `git status` and `git diff --stat` to see what's changed. If there are NO changes (working tree clean, nothing untracked), skip to step 6 and report "Already clean -- nothing to land."
